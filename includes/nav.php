        ...
        <div class="navbar-inner">
            ...
            <div class="navbar-right">
                ...
                <ul class="navbar-nav desktop-nav">
                    <li>
                        <a href="mumbai-glam-studio.infinityfree.me" class="<?php echo isActive('home', $current_page); ?>">Home</a>
                    </li>
                    <li>
                        <a href="salons.php" class="<?php echo isActive('salons', $current_page); ?>">All Salons</a>
                    </li>
                    <li>
...
<nav class="bottom-nav" aria-label="Mobile navigation">
    ...
    <a href="salons.php" class="<?php echo isActive('salons', $current_page); ?>">
        <i class="fas fa-list"></i><span>Salons</span>
    </a>
