...
(function () {
    ...
    var heroSearchForm = document.getElementById('hero-search');
    if (heroSearchForm) {
        heroSearchForm.addEventListener('submit', function (e) {
            e.preventDefault();
            var locality = this.querySelector('[name="locality"]');
            var locVal = locality ? locality.value : '';
            window.location.href = 'salons.php' + (locVal ? '?locality=' + encodeURIComponent(locVal) : '');
        });
    }
