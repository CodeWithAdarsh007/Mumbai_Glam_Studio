...
<section class="hero">
    ...
    <div class="container">
        <div class="hero-content">
            ...
            <!-- Smart Search -->
            <form id="hero-search" class="hero-search" onsubmit="return handleSmartSearch(event)">
                <select name="locality" id="search-locality" aria-label="Select locality">
                    <option value="">All Localities</option>
                    <?php foreach ($localities as $loc): ?>
                    <option value="<?php echo htmlspecialchars($loc); ?>"><?php echo htmlspecialchars($loc); ?></option>
                    <?php endforeach; ?>
                </select>
                <input type="text" id="search-query" placeholder="Search: bridal makeup, haircut, Andheri, under ₹5000..." aria-label="Search">
            ...
            <div id="ai-search-results" style="display: none;" class="ai-search-results">
                <div class="ai-badge">
                    <i class="fas fa-sparkles"></i> <span id="ai-badge-text">AI Search</span>
                </div>
                <div class="result-count" id="ai-result-count"></div>
                <div id="ai-loading" style="display: none;">
                    <div class="ai-search-loading">
                        <div class="spinner"></div>
                        <span style="color: var(--charcoal-muted);">Searching for the best matches...</span>
                    </div>
                </div>
                <div id="ai-results-grid" class="salon-grid"></div>
                <div id="ai-no-results" style="display: none;">
                    <p style="color: var(--charcoal-muted); text-align: center; padding: 20px;">
